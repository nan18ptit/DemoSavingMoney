...
import com.example.savingmoney.adapter.ViewPagerAdapter;
            ...
            public void onPageSelected(int position) {
                switch (position){
                    ...
                    case 1: navigationView.getMenu().findItem(R.id.mHistory).setChecked(true);
                        break;
                    case 2: navigationView.getMenu().findItem(R.id.mSerch).setChecked(true);
                        break;
                }
            }
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.mHome:viewPager.setCurrentItem(0);
                        break;
                    case R.id.mHistory:e:viewPager.setCurrentItem(1);
                        break;
                    case R.id.mSerch:viewPager.setCurrentItem(2);
                        break;
                }
                return true;
            }
